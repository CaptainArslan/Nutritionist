...
<div class="container-fluid">
        ...
        <div class="col-xl-12 col-xxl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Nutritionist</h4>
                </div>
                <div class="card-body">
                            ...
                            <div class="settings-form">
                                <form action="{{route('nutrition')}}" method="POST">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            <h5>Password:</h5>
                                            <input type="password" name="password" id="password" placeholder="password" class="form-control" value="123" readonly>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            <h5>Experience:</h5>
                                            <input type="number" id="experience" name="experience" placeholder="In years" class="form-control" value="{{old('experience')}}">
                                            <span class="text-danger">@error('experience'){{$message}} @enderror</span>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <h5>Address:</h5>
                                            <textarea name="address" id="address" class="form-control " placeholder="1234 Main St" value="{{old('address')}}"></textarea>
                                        </div>
                                        <button class="btn btn-primary" id="" type="submit" value="add" name="addnutritionist">Add Nutrition</button>
                                </form>
                            </div>
                        </div>
                    </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Latest Nutritionist</h4>
            </div>
            <div class="card-body">
