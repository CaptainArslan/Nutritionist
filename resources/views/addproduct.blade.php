@extends('container')
@section('title','Product | Nutritionist')
...
<div class="container-fluid">
                                ...
                                <form action="{{route('add_product')}}" method="POST">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select id="" name="ntcom" class="form-control" value="{{old('ntcom')}}">
                                            ...
                                            <span class="text-danger">@error('ntcom'){{$message}} @enderror</span>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <h5>Serving:</h5>
                                            <div class="input-group">
                                                <input type="text" name="serving" placeholder="Product Serving" class="form-control" value="{{old('serving')}}">
                                                <div class="input-group-prepend">
                                                    <select name="servingunit" class="btn btn-primary ">
                                            ...
                                            <span class="text-danger">@error('serving'){{$message}} @enderror</span>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <h5> Calories:</h5>
                                            <input type="number" name="calories" placeholder="Calories" class="form-control" value="{{old('calories')}}">
                                            <span class="text-danger">@error('calories'){{$message}} @enderror</span>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <h5> Proteins:</h5>
                                            <input type="number" name="proteins" placeholder="Proteins" class="form-control" value="{{old('proteins')}}">
                                            <span class="text-danger">@error('proteins'){{$message}} @enderror</span>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <h5> Carbohydrates:</h5>
                                            <input type="number" name="carbs" placeholder="Carbohydrates" class="form-control" value="{{old('carbs')}}">
                                            <span class="text-danger">@error('carbs'){{$message}} @enderror</span>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <h5> Fats</h5>
                                            <input type="number" name="fats" id="user_age" placeholder="Fats" class="form-control" value="{{old('fats')}}">
                                            <span class="text-danger">@error('fats'){{$message}} @enderror</span>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <h5>Status:</h5>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <textarea name="comment" id="comment" placeholder="Additional information" class="form-control" value="{{old('')}}"></textarea>
                                    </div>
                                    <center>
                                        <button class="btn btn-primary" type="submit" name="submit" id="submit" value="Save">Add Products</button>
                                    </center>
                                </form>
                            </div>
                        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Latest Added Products</h4>
                </div>
                <div class="card-body">
